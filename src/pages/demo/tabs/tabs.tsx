  ...
  return (
    <View className={"demo"}>
      ...
      <TmCard tmRound className={"demo__card"} tmTitle={"水平显示"}>
        <TmTabs>
          <TmTabsItem tmTitle={"页面1"}>内容 1</TmTabsItem>
          <TmTabsItem tmTitle={"页面2"}>内容 2</TmTabsItem>
          <TmTabsItem tmTitle={"页面3"}>内容 3</TmTabsItem>
          <TmTabsItem tmTitle={"页面4"}>内容 4</TmTabsItem>
          <TmTabsItem tmTitle={"页面5"}>内容 5</TmTabsItem>
          <TmTabsItem tmTitle={"页面6"}>内容 6</TmTabsItem>
        </TmTabs>
      </TmCard>
      <TmCard tmRound className={"demo__card"} tmTitle={"垂直显示"}>
        <TmTabs tmVertical>
          <TmTabsItem tmTitle={"页面1"}>
