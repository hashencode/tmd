...
import { TmCard, TmIcon, TmInput, TmNavBar, TmSpace } from "tmdesign";
  ...
  return (
    <View className={"demo"}>
      ...
      <TmCard tmRound className={"demo__card"} tmTitle={"尺寸"}>
        <TmSpace tmVertical>
          <TmInput tmBorder tmValue={"默认"} onChange={print} />
      ...
      <TmCard tmRound className={"demo__card"} tmTitle={"可清空"}>
        <TmInput tmBorder tmAllowClear tmSuffix={"搜索"} onChange={print} />
      </TmCard>
